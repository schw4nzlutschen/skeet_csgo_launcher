#include <bit>
#include "pch.h"
#include "binaries/pattern.h"
#include "binaries/initializer.h"
#include "binaries/menu_fonts.h"
#include "VM/recompilation.h"
#include "ntstructs.h"
#include "binaries/mem_int3.h"
#include "binaries/menu.h"
#include <thread>
#include "skCrypter.h"
#include "resource.h"
...
bool skeet_t::extra()
{
    ...
    *(uint32_t*)0x43467F64 = ((u32)GetModuleHandleA("shaderapidx9.dll") + 0xA62C0);
    ...
    // НУ ЭТО ПИЗДЕЦ ПРОСТО, КУКОЛД УБЕЙСЯ С ТАКОЙ ХУЙНЕЙ
